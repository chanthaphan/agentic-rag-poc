# knowledge/debit-card

Drop documents for the **debit-card** skill here (`.md` or `.pdf`, Thai or English, any sub-folder structure).
...
Then run `uv run bankrag ingest --category debit-card`. README files are ignored by the ingester.
