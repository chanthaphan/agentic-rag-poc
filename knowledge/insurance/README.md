...
Drop documents for the **insurance** skill here (`.md` or `.pdf`, Thai or English, any sub-folder structure).
...
Then run `uv run bankrag ingest --category insurance`. README files are ignored by the ingester.
