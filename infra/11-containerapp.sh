...
ENVVARS=(
  ...
  APP_USER_NAME="${APP_USER_NAME:-Pim}" APP_USER_INITIALS="${APP_USER_INITIALS:-PW}" ASSISTANT_NAME="${ASSISTANT_NAME:-Assistant}" ASSISTANT_NAME_EN="${ASSISTANT_NAME_EN:-Grace}" DATA_DIR=/data
)
