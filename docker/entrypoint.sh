...
DATA="${DATA_DIR:-/data}"
mkdir -p "$DATA/.state"
for d in skills knowledge evals; do
...
export SKILLS_DIR="$DATA/skills" KNOWLEDGE_DIR="$DATA/knowledge" STATE_DIR="$DATA/.state" EVALS_DIR="$DATA/evals" PRICING_FILE="$DATA/pricing.yaml"
cd /app
