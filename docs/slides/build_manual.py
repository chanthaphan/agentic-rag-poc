...
B.process_steps(s, [("Open the app", "Go to localhost:8010. The phone screen greets you with three starter questions."),
                    ...
                    ("Sign in to Studio", "Click 'Studio' in the top bar. Access is by your Microsoft account: a Studio admin adds you under Settings > Access. Testers do everything except delete skills, files or conversations, full re-ingest, change base rules, models, prices, import bundles or manage access.")], y=3.25, accent_upto=0)
